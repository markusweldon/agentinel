...
<style>
  ...
  *{box-sizing:border-box}
  ...
  {% endfor %}
  {% else %}
  <div class="allclear">✓ No findings — this target passed every agentinel check.</div>
  {% endif %}

  <footer>Generated by <a href="https://github.com/markusweldon/agentinel">agentinel</a> ·
